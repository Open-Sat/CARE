 ...
 *
 */
public class CfeFileDialog extends  Dialog {

   private static Logger logger=Logger.getLogger(CfeFileDialog.class);
    ...
    */
   public CfeFileDialog(Shell parent, CfeFile cfeFile) {

      this (parent, SWT.RESIZE | SWT.CLOSE | SWT.MODELESS | SWT.TITLE, cfeFile);
    ...
    * @param fswFile  cFE file that is being displayed           
    */
   public CfeFileDialog(Shell parent, int style, CfeFile cfeFile) {
